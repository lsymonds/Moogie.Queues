...
{
    /// <summary>
    /// Exception that is thrown when the Expiry property on the <see cref="Dispatchable"/> class is invalid.
    /// </summary>
    public class InvalidDispatchableExpiryException : Exception
    {
        /// <summary>
        /// Gets or sets the expiry value that was set against the <see cref="Dispatchable"/> instance.
        /// </summary>
        ...
        /// The expiry value that was set against the <see cref="Dispatchable"/> instance.
        /// </param>
